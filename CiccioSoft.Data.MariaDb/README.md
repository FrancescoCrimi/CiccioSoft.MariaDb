...
ADO.NET provider for MariaDB Embedded, built on top of the CiccioSoft.MariaDb.Interop layer.
...
- Uses the CiccioSoft.MariaDb.Interop layer for native operations
...
This provider is built on top of `CiccioSoft.MariaDb.Interop`, which handles the low-level P/Invoke interactions with MariaDB Connector/C. The provider translates .NET ADO.NET calls into native MariaDB operations.
