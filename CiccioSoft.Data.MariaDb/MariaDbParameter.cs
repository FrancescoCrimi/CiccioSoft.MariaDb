...
/// </summary>
public sealed class MariaDbParameter : DbParameter
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="MariaDbParameter"/> class with the specified name and value.
    /// </summary>
    /// <param name="parameterName">The name of the parameter.</param>
    /// <param name="value">The value of the parameter.</param>
    public MariaDbParameter(string parameterName, object? value)
    {
