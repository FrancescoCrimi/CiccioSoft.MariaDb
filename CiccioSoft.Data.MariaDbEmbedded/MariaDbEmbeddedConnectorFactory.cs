...
/// </summary>
public sealed class MariaDbEmbeddedConnectorFactory : DbProviderFactory
{
    /// <summary>
    /// Provides an instance of <see cref="DbProviderFactory"/> that can create MySqlConnector objects.
    /// </summary>
    public static readonly MariaDbEmbeddedConnectorFactory Instance = new();

    /// <summary>
    /// Creates a new <see cref="MySqlCommand"/> object.
    /// </summary>
    public override DbCommand CreateCommand() => new MariaDbEmbeddedCommand();

    /// <summary>
    /// Creates a new <see cref="MySqlConnection"/> object.
    /// </summary>
    public override DbConnection CreateConnection() => new MariaDbEmbeddedConnection();
    ...
    /// </summary>
    public override DbParameter CreateParameter() => new MariaDbEmbeddedParameter();
    ...
    private MariaDbEmbeddedConnectorFactory()
    {
    }
}
